...
public class ClusterYamlEmitter {
    ...
    private static string ClusterYamlHeaderText = @"name: STRINGS.CLUSTER_NAMES.CGSM_CLUSTER.NAME
...
";
    ...
    public ClusterYamlEmitter(Cluster clusterIn, string outputFileIn) {
    ...
    private void emitHeaders(ref StringBuilder yamlContent) {
        ...
        yamlContent.Append(ClusterYamlHeaderText);
